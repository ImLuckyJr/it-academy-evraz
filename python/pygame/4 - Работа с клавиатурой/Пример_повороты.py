...
block1d = pygame.image.load('snake.png')
block1l = pygame.transform.rotate(block1d.copy(), 90)
block1r = pygame.transform.rotate(block1d.copy(), -90)
block1t = pygame.transform.rotate(block1d.copy(), 180)
block2d = block1t.copy()
block2l = pygame.transform.rotate(block2d.copy(), 90)
block2r = pygame.transform.rotate(block2d.copy(), -90)
block2t = pygame.transform.rotate(block2d.copy(), 180)
